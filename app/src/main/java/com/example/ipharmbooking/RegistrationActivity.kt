...
class RegistrationActivity : AppCompatActivity() {
    ...
    private fun register() {
        ...
        showSimpleProgressDialog(this@RegistrationActivity, null, "Loading...", false)
    ...
    private fun onTaskCompleted(response: String, task: Int) {
        ...
        when (task) {
            RegTask -> if (isSuccess(response)) {
                ...
                Toast.makeText(this@RegistrationActivity, getErrorMessage(response), Toast.LENGTH_SHORT).show()
            }
        }
    }
